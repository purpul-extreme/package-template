...
> A Roblox Luau package template with [TestEZ](https://github.com/Roblox/testez) testing, [Selene](https://github.com/Kampfkarren/selene) linting, and [StyLua](https://github.com/JohnnyMorganz/StyLua) formatting preconfigured.
